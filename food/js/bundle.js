...
function calc() {
    ...
    initLocalSettings('.calculating__choose_big div', 'calculating__choose-item_active');
     ...
     function calcTotal() {
      ...
      function getStatEl(selector, activeClass) {
        const elements = document.querySelectorAll(selector);
     ...
     getStatEl('#gender div', 'calculating__choose-item_active');
     getStatEl('.calculating__choose_big div', 'calculating__choose-item_active');
    
      function getDynIn(selector) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
function tabs(tabsSelector, tadsContentSelector, tabsParentSelector, activeClass) {

    const tabs = document.querySelectorAll(tabsSelector),
        tabsContent = document.querySelectorAll(tadsContentSelector),
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', modalTimerId), 5000);
     ...
     (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__.default)('.timer', '2021-03-30');
